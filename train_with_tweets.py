...
hdlr = logging.FileHandler('/home/srinath/tweets_classifier_wip/myapp.log')
...
# Load data
print("Loading data...")
x, y, vocabulary,labels_dict,w2v_for_vocab = data_helpers.load_data(logger)
...
x_train, x_dev, y_train, y_dev = train_test_split(x_shuffled,y_shuffled,test_size=0.02,random_state=42)
'''x_train, x_dev = x_shuffled[:-250], x_shuffled[-250:]
y_train, y_dev = y_shuffled[:-250], y_shuffled[-250:]'''
